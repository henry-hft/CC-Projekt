                                    ...
                                    if ($enabled == "1") {
                                        if (!empty($_GET["hostname"])) {
                                            if (!empty($_GET["location"])) {
                                                if (!empty($_GET["plan"])) {
                                                    if (!empty($_GET["os"])) {
                                                        if (
                                                            ...
                                                            if (
                                                                ...
                                                                $scriptname = strtolower(
                                                                    $_GET[
                                                                        "script"
                                                                    ]
                                                                );
                                                                $query =
                                                                    "SELECT script FROM scripts WHERE name=:scriptname AND userid=:userid";
                                                                $stmt = $db->prepare(
                                                                    $query
                                                                );
                                                                $stmt->bindParam(
                                                            ...
                                                            $SSHKeyName = strtolower(
                                                                $_GET["sshkey"]
                                                            );
                                                            $query =
                                                                "SELECT sshkey FROM sshkeys WHERE name=:sshkeyname AND userid=:userid";
                                                            $stmt = $db->prepare(
                                                                $query
                                                            );
                                                            $stmt->bindParam(
                                                            ...
                                                            $createSSHKey = $providerObj->createSSHKey(
                                                                $sshkey
                                                            );
                                                            if (
                                                                $createSSHKey !=
                                                                ...
                                                                if (
                                                                    ...
                                                                    $createScript = $providerObj->createScript(
                                                                        $script
                                                                    );
                                                                    if (
                                                                        !is_null(
                                                                        ...
                                                                        if (
                                                                            ...
                                                                            $response = [
                                                                                "error" => true,
                                                                                "message" =>
                                                                                    "Could not create startup script"
                                                                            ];
                                                                            http_response_code(
                                                                                400
                                                                            );
                                                                ...
                                                                for (
                                                                    ...
                                                                    if (
                                                                        ...
                                                                        $createResponse = $providerObj->create(
                                                                            $_GET[
                                                                                "hostname"
                                                                            ],
                                                                            $_GET[
                                                                ...
                                                                $deleteSSHKey = $providerObj->deleteSSHKey(
                                                                    $createSSHKey
                                                                );
                                                                $deleteScript = $providerObj->deleteScript(
                                                                    $createScript
                                                                );
                                                                if (
                                                                    $createResponse[
                                                            ...
                                                            $response = [
                                                                "error" => true,
                                                                "message" =>
                                                                    "The sshkey id parameter is missing."
                                                            ];
                                                            http_response_code(
                                                                400
                                                            );
                                                        ...
                                                        $response = [
                                                            "error" => true,
                                                            "message" =>
                                                                "The server os parameter is missing."
                                                        ];
                                                        http_response_code(400);
                                                    }
                                                } else {
                                                    $response = [
                                                        "error" => true,
                                                        "message" =>
                                                            "The server plan parameter is missing."
                                                    ];
                                                    http_response_code(400);
                                                }
                                            } else {
                                                $response = [
                                                    "error" => true,
                                                    "message" =>
                                                        "The server location parameter is missing."
                                                ];
                                                http_response_code(400);
                                            }
                                        } else {
                                            $response = [
                                                "error" => true,
                                                "message" =>
                                                    "The server hostname parameter is missing."
                                            ];
                                            http_response_code(400);
                                        }
                                    } else {
